...
The CLI reads files under `~/.claude/projects/*/memory.jsonl` — Claude Code's local session archives. The scanner extracts only **assistant** message records and pulls out:
